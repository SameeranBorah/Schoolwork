...
int client_UDP_connect(char * serverName, char * portNumber){
...
// Function returns an int that refers to the server's listening socket
// You can call accept with this socket later
int server_UDP_listen(char *portNumber, int backlog){
...
int server_UDP_accept(int listenSocket){
	//printf("Inside server_UDP_accept()\n");
	int connectionSocket, sin_size;
...
void write_socket(int fd, const void *buffer, size_t size){
	int obytes;
...
void read_socket(int fd, void *buffer, size_t size){
	int ibytes;
